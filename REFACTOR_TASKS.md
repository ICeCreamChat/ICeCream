...
- [ ] `npm test` 无 fail（1279 个用例，至少 1278 通过）
- [ ] 拆分后原文件行数符合目标（P1 < 2000行，P2 < 300行，P3 < 800行，P4 < 1200行）
- [ ] 所有原有导出函数签名不变（同名、同参数、同返回结构）
- [ ] 无新增的跨模块依赖（seating 不引用 timetable，反之亦然）
- [ ] `docs/architecture/MODULES.md` 中对应模块卡片已更新文件路径
