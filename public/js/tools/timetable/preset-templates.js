export const PRESET_TEMPLATES = {
    ...
    withMorningEvening: {
        ...
        globalDefaults: { classMinutes: 45, breakMinutes: 10 },
        segments: [
            { id: 'seg-1', label: '早读', startTime: '07:20', periodCount: 1, classMinutes: 30, breakMinutes: 10, kind: 'teaching' },
    ...
    seniorHigh: {
        ...
        globalDefaults: { classMinutes: 45, breakMinutes: 10 },
        segments: [
            { id: 'seg-1', label: '早读', startTime: '07:30', periodCount: 1, classMinutes: 30, breakMinutes: 10, kind: 'teaching' },
