...
import { TIMETABLE_REQUIREMENT_INTENTS } from './timetable-ai-prompts.js';
import { normalizeTimetableMarketText } from './timetable-language-normalizer.js';
import { alignAiArtifactsToSources } from './timetable-constraints/ai-source-alignment.js';
import { validateSemanticRelationGraph } from './timetable-constraints/semantic-planning.js';

class TimetableAiExtractionError extends Error {
...
function validateExtractionPayload(payload = {}, { sourceRequirements = [], project = {} } = {}) {
...
function resolveEntityRefs(projectInput = {}, requirements = []) {
